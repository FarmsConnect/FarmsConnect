...
const News = (props) => {
  ...
  return (
    ...
    <div className="flex justify-center">
      <div
        className="flex flex-col rounded-lg bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 shadow-lg dark:bg-neutral-700 md:max-w-xl md:flex-row">
        {/* <a href={props.url}> */}
        <img
        ...
        <div className="flex flex-col justify-start p-2">
          <h5
            ...
            {props.title}... <span className="bg-red-500 text-white text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Latest</span>
          </h5>
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-300">
            <span style={{ color: "#082850" }}>Author : {(props.author) ? props.author : ""} </span>
            <p className="text-black">Source : {props.sourceName}</p>
          </p>
          <a href={props.url} target="_blank" rel="noreferrer">
